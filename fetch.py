#!/usr/bin/env python3
"""
Recupero codici sconto Adidas da shopilo.it
Sursa: https://shopilo.it/negozi/adidas.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/adidas.it"
STORE_NAME = "Adidas"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Adidas da shopilo.it"""
    headers = {
